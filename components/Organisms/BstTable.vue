...
<v-col cols="12" >
  <v-card class="wraper">
    ...
    <div class="table">
      <div class="items">
        <tr><td>年</td></tr>
        <tr class="sum"><td>資産</td></tr>
        <tr class="semi-sum"><td>流動資産</td></tr>
        <tr><td>現金</td></tr>
        <tr><td>売掛金</td></tr>
        <tr><td>売上比</td></tr>
        <tr><td>商品その他</td></tr>
        <tr><td>売上比</td></tr>
        <tr class="semi-sum"><td>固定資産</td></tr>
        <tr><td>土地・建物</td></tr>
        <tr><td>投資その他</td></tr>
        <tr class="sum"><td>負債</td></tr>
        <tr class="semi-sum"><td>流動負債</td></tr>
        <tr><td>買掛金</td></tr>
        <tr><td>原価比</td></tr>
        <tr><td>その他</td></tr>
        <tr class="semi-sum"><td>固定負債</td></tr>
        <tr><td>長期借入金</td></tr>
        <tr><td>その他</td></tr>
        <tr class="sum"><td>株主資本</td></tr>
        <tr><td>資本金</td></tr>
        <tr class="semi-sum"><td>利益余剰金</td></tr>
